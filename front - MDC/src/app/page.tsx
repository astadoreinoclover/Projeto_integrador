...
export default function Home() {
  return (
    <>
      <Titulo/>
      <h1 className="inicial">Complete sua coleção com a gente</h1>
      <form className="mr-1.5" style={{width: '100vw'}}>   
        <label htmlFor="default-search" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Pesquisar</label>
        <div style={{width: '80vw', margin: 'auto', marginTop: '20px'}} className="relative">
          <input style={{borderRadius: '50px'}}  type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300  bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Qual titulo você procura?" required />
